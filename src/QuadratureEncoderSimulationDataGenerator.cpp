...
U32 QuadratureEncoderSimulationDataGenerator::GenerateSimulationData( U64 largest_sample_requested, U32 sample_rate, SimulationChannelDescriptor** simulation_channel )
{
...
void QuadratureEncoderSimulationDataGenerator::CreateSerialByte()
{
